...
class NaverDatalabAPI:
    ''''Parameters
    \n\n-----------------------------\n\nstartDate\nType : string
    Requirement : Yes, Explanation : 조회 기간 시작 날짜(yyyy-mm-dd 형식). 2016년 1월 1일부터 조회할 수 있습니다.\n\n
    endDate\n
    Type : string , Requirement : Yes, Explanation : 조회 기간 종료 날짜(yyyy-mm-dd 형식)\n\n
    timeUnit\nType : string,Requirement : Yes
    Explanation : 구간 단위\n- date: 일간\n- week: 주간\n- month: 월간\n\n
    keywords
    \nType : array(JSON)
    Requirement : Yes
    ...
    def __init(self,client_id = "bZWIA91H20kesR3Oru7w",client_secret = "fTsukml_0L"):
